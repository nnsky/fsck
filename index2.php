...
<body>
	...
	<center>
		<div class="row lelang">
			<div class="container">
				<br>
				<img src="bazaar/basic/logoll.png" class="img-fluid">
			</div>
			<div class="glider">

				<img class="img-fluid" src="bazaar/index/41.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/42.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/43.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/31.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/32.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/33.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/21.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/22.jpg" style="margin:2px;">
				<img class="img-fluid" src="bazaar/index/23.jpg" style="margin:2px;">
			</div>
		</div>
		...
		<div class="row lelang">
			<div class="container">
				<br>
				<a href="flashsale"><img src="bazaar/basic/logofs2.png" class="img-fluid"></a>
...
<script>
	...
	// Set the date we're counting down to
	var countDownDates = new Date("DEC 14, 2021 21:00:00").getTime();
	var countDownDatess = new Date("DEC 17, 2021 10:00:00").getTime();
