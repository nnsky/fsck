...
<body>
    ...
    <div class='row'>
        ...
        if ($jam <= 260959) {
            echo "
		<div class='col-sm-6'>
		<img src='../fsdesc/produk/sesi4/spring/13.png' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/spring/b13.png' class='img-responsive'>
		</div>
	";
	...
	<a type='button' data-toggle='modal' data-target='#produk1'>
		<img src='../fsdesc/produk/sesi4/mulai/19.jpg' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/mulai/b19.jpg' class='img-responsive'>
	</a>
	</div>
	";
	...
	";
        ...
        if ($jam <= 260959) {
            echo "
		<div class='col-sm-6'>
		<img src='../fsdesc/produk/sesi4/spring/14.png' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/spring/b14.png' class='img-responsive'>
		</div>
	";
        } else if (($jam >= 261000 && $jam < 282059) && $hsleep['stock'] >= 1) {
            echo "
	...
	<a type='button' data-toggle='modal' data-target='#produk2'>
		<img src='../fsdesc/produk/sesi4/mulai/20.jpg' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/mulai/b20.jpg' class='img-responsive'>
	</a>
	</div>
	";
        } else if ($hsleep["stock"] == 0) {
	...
	";
        ...
        if ($jam <= 260959) {
            echo "
		<div class='col-sm-6'>
		<img src='../fsdesc/produk/sesi4/spring/15.png' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/spring/b15.png' class='img-responsive'>
		</div>
	";
        } else if (($jam >= 261000 && $jam < 282059) && $hsleep['stock'] >= 1) {
            echo "
	...
	<a type='button' data-toggle='modal' data-target='#produk3'>
		<img src='../fsdesc/produk/sesi4/mulai/21.jpg' class='img-responsive'>
		<img src='../fsdesc/produk/sesi4/mulai/b21.jpg' class='img-responsive'>
	</a>
	</div>
	";
        } else if ($hsleep["stock"] == 0) {
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <center><b>Dreamline Celebrity 160x200</b></center>
                    </h5>
    ...
    <div class="modal fade" id="produk2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <center><b>Dreamline Celebrity Set 180x200</b></center>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
    ...
    <div class="modal fade" id="produk3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <center><b>Dreamline Celebrity Set 200x200</b></center>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
